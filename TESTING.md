...
- Parser contracts and YOLO golden row fixtures for YOLO11-style raw-grid outputs, YOLO26 end-to-end detection/pose/segmentation rows, and segmentation contour reconstruction.
...
```text
EditMode: 131 tests, 131 passed, 0 failed
